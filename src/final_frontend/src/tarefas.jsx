...
function tarefas() {
  ...
  async function consultarTarefas(){
      setTarefas(await final_backend.getTarefas());    
  }
  ...
  async function handleSubmit(event) {
    ...
    if( idTarefa === null || idTarefa === ""){
        await final_backend.addTarefa(descricao, categoria, false, false);            
    } else {
        await final_backend.alterarTarefa( parseInt(idTarefa), categoria, descricao, urgente, false );    
    }
  ...
  async function excluir(id) {        
    await final_backend.excluirTarefa( parseInt(id));    
    consultarTarefas();
  }

  async function alterar( id, categoria, descricao, urgente, concluida) {      
    await final_backend.alterarTarefa( parseInt(id), categoria, descricao, urgente, concluida );    
    consultarTarefas();    
  }
